...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:wn,depthTest:!1,depthWrite:!1})}function xo(){return new ze({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:wa(),fragmentShader:`
		...
		`,blending:wn,depthTest:!1,depthWrite:!1})}function Mo(){return new ze({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:wa(),fragmentShader:`
...
#define LOW_PRECISION`),t}function Ep(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Jo?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Vl?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===ln&&(t="SHADOWMAP_TYPE_VSM"),t}function Tp(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case pi:case mi:t="ENVMAP_TYPE_CUBE";break;case Ir:t="ENVMAP_TYPE_CUBE_UV";break}return t}function bp(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case mi:t="ENVMAP_MODE_REFRACTION";break}return t}function wp(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case fa:t="ENVMAP_BLENDING_MULTIPLY";break;case lc:t="ENVMAP_BLENDING_MIX";break;case cc:t="ENVMAP_BLENDING_ADD";break}return t}function Ap(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Rp(i,t,e,n){const r=i.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Ep(e),c=Tp(e),h=bp(e),u=wp(e),d=Ap(e),f=mp(e),g=gp(s),v=r.createProgram();let p,m,b=e.glslVersion?"#version "+e.glslVersion+`
...
}`;function Yp(i,t,e){let n=new ba;const r=new st,s=new st,a=new Gt,o=new kp({depthPacking:xc}),l=new Vp,c={},h=e.maxTextureSize,u={[Rn]:we,[we]:Rn,[Je]:Je},d=new ze({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new st},radius:{value:4}},vertexShader:Wp,fragmentShader:Xp}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new Se;g.setAttribute("position",new Ze(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new ie(g,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Jo;let m=this.type;this.render=function(C,A,R){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||C.length===0)return;const k=i.getRenderTarget(),_=i.getActiveCubeFace(),M=i.getActiveMipmapLevel(),F=i.state;F.setBlending(wn),F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);const N=m!==ln&&this.type===ln,B=m===ln&&this.type!==ln;for(let X=0,O=C.length;X<O;X++){const K=C[X],W=K.shadow;if(W===void 0){console.warn("THREE.WebGLShadowMap:",K,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;r.copy(W.mapSize);const rt=W.getFrameExtents();if(r.multiply(rt),s.copy(W.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/rt.x),r.x=s.x*rt.x,W.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/rt.y),r.y=s.y*rt.y,W.mapSize.y=s.y)),W.map===null||N===!0||B===!0){const mt=this.type!==ln?{minFilter:Pe,magFilter:Pe}:{};W.map!==null&&W.map.dispose(),W.map=new mn(r.x,r.y,mt),W.map.texture.name=K.name+".shadowMap",W.camera.updateProjectionMatrix()}i.setRenderTarget(W.map),i.clear();const nt=W.getViewportCount();for(let mt=0;mt<nt;mt++){const Lt=W.getViewport(mt);a.set(s.x*Lt.x,s.y*Lt.y,s.x*Lt.z,s.y*Lt.w),F.viewport(a),W.updateMatrices(K,mt),n=W.getFrustum(),T(A,R,W.camera,K,this.type)}W.isPointLightShadow!==!0&&this.type===ln&&b(W,R),W.needsUpdate=!1}m=this.type,p.needsUpdate=!1,i.setRenderTarget(k,_,M)};function b(C,A){const R=t.update(v);d.defines.VSM_SAMPLES!==C.blurSamples&&(d.defines.VSM_SAMPLES=C.blurSamples,f.defines.VSM_SAMPLES=C.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new mn(r.x,r.y)),d.uniforms.shadow_pass.value=C.map.texture,d.uniforms.resolution.value=C.mapSize,d.uniforms.radius.value=C.radius,i.setRenderTarget(C.mapPass),i.clear(),i.renderBufferDirect(A,null,R,d,v,null),f.uniforms.shadow_pass.value=C.mapPass.texture,f.uniforms.resolution.value=C.mapSize,f.uniforms.radius.value=C.radius,i.setRenderTarget(C.map),i.clear(),i.renderBufferDirect(A,null,R,f,v,null)}function S(C,A,R,k){let _=null;const M=R.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(M!==void 0)_=M;else if(_=R.isPointLight===!0?l:o,i.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const F=_.uuid,N=A.uuid;let B=c[F];B===void 0&&(B={},c[F]=B);let X=B[N];X===void 0&&(X=_.clone(),B[N]=X,A.addEventListener("dispose",L)),_=X}if(_.visible=A.visible,_.wireframe=A.wireframe,k===ln?_.side=A.shadowSide!==null?A.shadowSide:A.side:_.side=A.shadowSide!==null?A.shadowSide:u[A.side],_.alphaMap=A.alphaMap,_.alphaTest=A.alphaTest,_.map=A.map,_.clipShadows=A.clipShadows,_.clippingPlanes=A.clippingPlanes,_.clipIntersection=A.clipIntersection,_.displacementMap=A.displacementMap,_.displacementScale=A.displacementScale,_.displacementBias=A.displacementBias,_.wireframeLinewidth=A.wireframeLinewidth,_.linewidth=A.linewidth,R.isPointLight===!0&&_.isMeshDistanceMaterial===!0){const F=i.properties.get(_);F.light=R}return _}function T(C,A,R,k,_){if(C.visible===!1)return;if(C.layers.test(A.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&_===ln)&&(!C.frustumCulled||n.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(R.matrixWorldInverse,C.matrixWorld);const N=t.update(C),B=C.material;if(Array.isArray(B)){const X=N.groups;for(let O=0,K=X.length;O<K;O++){const W=X[O],rt=B[W.materialIndex];if(rt&&rt.visible){const nt=S(C,rt,k,_);C.onBeforeShadow(i,C,A,R,N,nt,W),i.renderBufferDirect(R,null,N,nt,C,W),C.onAfterShadow(i,C,A,R,N,nt,W)}}}else if(B.visible){const X=S(C,B,k,_);C.onBeforeShadow(i,C,A,R,N,X,null),i.renderBufferDirect(R,null,N,X,C,null),C.onAfterShadow(i,C,A,R,N,X,null)}}const F=C.children;for(let N=0,B=F.length;N<B;N++)T(F[N],A,R,k,_)}function L(C){C.target.removeEventListener("dispose",L);for(const R in c){const k=c[R],_=C.target.uuid;_ in k&&(k[_].dispose(),delete k[_])}}}const qp={[Ps]:Ls,[Ds]:Ns,[Us]:Fs,[fi]:Is,[Ls]:Ps,[Ns]:Ds,[Fs]:Us,[Is]:fi};function Zp(i){function t(){let D=!1;const lt=new Gt;let V=null;const j=new Gt(0,0,0,0);return{setMask:function(at){V!==at&&!D&&(i.colorMask(at,at,at,at),V=at)},setLocked:function(at){D=at},setClear:function(at,ct,Ht,le,Ae){Ae===!0&&(at*=le,ct*=le,Ht*=le),lt.set(at,ct,Ht,le),j.equals(lt)===!1&&(i.clearColor(at,ct,Ht,le),j.copy(lt))},reset:function(){D=!1,V=null,j.set(-1,0,0,0)}}}function e(){let D=!1,lt=!1,V=null,j=null,at=null;return{setReversed:function(ct){lt=ct},setTest:function(ct){ct?gt(i.DEPTH_TEST):ht(i.DEPTH_TEST)},setMask:function(ct){V!==ct&&!D&&(i.depthMask(ct),V=ct)},setFunc:function(ct){if(lt&&(ct=qp[ct]),j!==ct){switch(ct){case Ps:i.depthFunc(i.NEVER);break;case Ls:i.depthFunc(i.ALWAYS);break;case Ds:i.depthFunc(i.LESS);break;case fi:i.depthFunc(i.LEQUAL);break;case Us:i.depthFunc(i.EQUAL);break;case Is:i.depthFunc(i.GEQUAL);break;case Ns:i.depthFunc(i.GREATER);break;case Fs:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}j=ct}},setLocked:function(ct){D=ct},setClear:function(ct){at!==ct&&(i.clearDepth(ct),at=ct)},reset:function(){D=!1,V=null,j=null,at=null}}}function n(){let D=!1,lt=null,V=null,j=null,at=null,ct=null,Ht=null,le=null,Ae=null;return{setTest:function(Wt){D||(Wt?gt(i.STENCIL_TEST):ht(i.STENCIL_TEST))},setMask:function(Wt){lt!==Wt&&!D&&(i.stencilMask(Wt),lt=Wt)},setFunc:function(Wt,Re,tn){(V!==Wt||j!==Re||at!==tn)&&(i.stencilFunc(Wt,Re,tn),V=Wt,j=Re,at=tn)},setOp:function(Wt,Re,tn){(ct!==Wt||Ht!==Re||le!==tn)&&(i.stencilOp(Wt,Re,tn),ct=Wt,Ht=Re,le=tn)},setLocked:function(Wt){D=Wt},setClear:function(Wt){Ae!==Wt&&(i.clearStencil(Wt),Ae=Wt)},reset:function(){D=!1,lt=null,V=null,j=null,at=null,ct=null,Ht=null,le=null,Ae=null}}}const r=new t,s=new e,a=new n,o=new WeakMap,l=new WeakMap;let c={},h={},u=new WeakMap,d=[],f=null,g=!1,v=null,p=null,m=null,b=null,S=null,T=null,L=null,C=new St(0,0,0),A=0,R=!1,k=null,_=null,M=null,F=null,N=null;const B=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let X=!1,O=0;const K=i.getParameter(i.VERSION);K.indexOf("WebGL")!==-1?(O=parseFloat(/^WebGL (\d)/.exec(K)[1]),X=O>=1):K.indexOf("OpenGL ES")!==-1&&(O=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),X=O>=2);let W=null,rt={};const nt=i.getParameter(i.SCISSOR_BOX),mt=i.getParameter(i.VIEWPORT),Lt=new Gt().fromArray(nt),It=new Gt().fromArray(mt);function Y(D,lt,V,j){const at=new Uint8Array(4),ct=i.createTexture();i.bindTexture(D,ct),i.texParameteri(D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(D,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ht=0;Ht<V;Ht++)D===i.TEXTURE_3D||D===i.TEXTURE_2D_ARRAY?i.texImage3D(lt,0,i.RGBA,1,1,j,0,i.RGBA,i.UNSIGNED_BYTE,at):i.texImage2D(lt+Ht,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,at);return ct}const J={};J[i.TEXTURE_2D]=Y(i.TEXTURE_2D,i.TEXTURE_2D,1),J[i.TEXTURE_CUBE_MAP]=Y(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),J[i.TEXTURE_2D_ARRAY]=Y(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),J[i.TEXTURE_3D]=Y(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),a.setClear(0),gt(i.DEPTH_TEST),s.setFunc(fi),Ft(!1),kt(ka),gt(i.CULL_FACE),P(wn);function gt(D){c[D]!==!0&&(i.enable(D),c[D]=!0)}function ht(D){c[D]!==!1&&(i.disable(D),c[D]=!1)}function Ct(D,lt){return h[D]!==lt?(i.bindFramebuffer(D,lt),h[D]=lt,D===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=lt),D===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=lt),!0):!1}function Et(D,lt){let V=d,j=!1;if(D){V=u.get(lt),V===void 0&&(V=[],u.set(lt,V));const at=D.textures;if(V.length!==at.length||V[0]!==i.COLOR_ATTACHMENT0){for(let ct=0,Ht=at.length;ct<Ht;ct++)V[ct]=i.COLOR_ATTACHMENT0+ct;V.length=at.length,j=!0}}else V[0]!==i.BACK&&(V[0]=i.BACK,j=!0);j&&i.drawBuffers(V)}function Bt(D){return f!==D?(i.useProgram(D),f=D,!0):!1}const jt={[zn]:i.FUNC_ADD,[Xl]:i.FUNC_SUBTRACT,[Yl]:i.FUNC_REVERSE_SUBTRACT};jt[ql]=i.MIN,jt[Zl]=i.MAX;const zt={[Kl]:i.ZERO,[jl]:i.ONE,[$l]:i.SRC_COLOR,[Rs]:i.SRC_ALPHA,[ic]:i.SRC_ALPHA_SATURATE,[ec]:i.DST_COLOR,[Ql]:i.DST_ALPHA,[Jl]:i.ONE_MINUS_SRC_COLOR,[Cs]:i.ONE_MINUS_SRC_ALPHA,[nc]:i.ONE_MINUS_DST_COLOR,[tc]:i.ONE_MINUS_DST_ALPHA,[rc]:i.CONSTANT_COLOR,[sc]:i.ONE_MINUS_CONSTANT_COLOR,[ac]:i.CONSTANT_ALPHA,[oc]:i.ONE_MINUS_CONSTANT_ALPHA};function P(D,lt,V,j,at,ct,Ht,le,Ae,Wt){if(D===wn){g===!0&&(ht(i.BLEND),g=!1);return}if(g===!1&&(gt(i.BLEND),g=!0),D!==Wl){if(D!==v||Wt!==R){if((p!==zn||S!==zn)&&(i.blendEquation(i.FUNC_ADD),p=zn,S=zn),Wt)switch(D){case hi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Va:i.blendFunc(i.ONE,i.ONE);break;case Wa:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Xa:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case hi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Va:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Wa:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Xa:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}m=null,b=null,T=null,L=null,C.set(0,0,0),A=0,v=D,R=Wt}return}at=at||lt,ct=ct||V,Ht=Ht||j,(lt!==p||at!==S)&&(i.blendEquationSeparate(jt[lt],jt[at]),p=lt,S=at),(V!==m||j!==b||ct!==T||Ht!==L)&&(i.blendFuncSeparate(zt[V],zt[j],zt[ct],zt[Ht]),m=V,b=j,T=ct,L=Ht),(le.equals(C)===!1||Ae!==A)&&(i.blendColor(le.r,le.g,le.b,Ae),C.copy(le),A=Ae),v=D,R=!1}function Le(D,lt){D.side===Je?ht(i.CULL_FACE):gt(i.CULL_FACE);let V=D.side===we;lt&&(V=!V),Ft(V),D.blending===hi&&D.transparent===!1?P(wn):P(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),s.setFunc(D.depthFunc),s.setTest(D.depthTest),s.setMask(D.depthWrite),r.setMask(D.colorWrite);const j=D.stencilWrite;a.setTest(j),j&&(a.setMask(D.stencilWriteMask),a.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),a.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),te(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?gt(i.SAMPLE_ALPHA_TO_COVERAGE):ht(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ft(D){k!==D&&(D?i.frontFace(i.CW):i.frontFace(i.CCW),k=D)}function kt(D){D!==Gl?(gt(i.CULL_FACE),D!==_&&(D===ka?i.cullFace(i.BACK):D===kl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ht(i.CULL_FACE),_=D}function bt(D){D!==M&&(X&&i.lineWidth(D),M=D)}function te(D,lt,V){D?(gt(i.POLYGON_OFFSET_FILL),(F!==lt||N!==V)&&(i.polygonOffset(lt,V),F=lt,N=V)):ht(i.POLYGON_OFFSET_FILL)}function Rt(D){D?gt(i.SCISSOR_TEST):ht(i.SCISSOR_TEST)}function w(D){D===void 0&&(D=i.TEXTURE0+B-1),W!==D&&(i.activeTexture(D),W=D)}function x(D,lt,V){V===void 0&&(W===null?V=i.TEXTURE0+B-1:V=W);let j=rt[V];j===void 0&&(j={type:void 0,texture:void 0},rt[V]=j),(j.type!==D||j.texture!==lt)&&(W!==V&&(i.activeTexture(V),W=V),i.bindTexture(D,lt||J[D]),j.type=D,j.texture=lt)}function z(){const D=rt[W];D!==void 0&&D.type!==void 0&&(i.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function Z(){try{i.compressedTexImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function $(){try{i.compressedTexImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function q(){try{i.texSubImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function vt(){try{i.texSubImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function it(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ut(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Vt(){try{i.texStorage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Q(){try{i.texStorage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function dt(){try{i.texImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function wt(){try{i.texImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function At(D){Lt.equals(D)===!1&&(i.scissor(D.x,D.y,D.z,D.w),Lt.copy(D))}function ft(D){It.equals(D)===!1&&(i.viewport(D.x,D.y,D.z,D.w),It.copy(D))}function Ot(D,lt){let V=l.get(lt);V===void 0&&(V=new WeakMap,l.set(lt,V));let j=V.get(D);j===void 0&&(j=i.getUniformBlockIndex(lt,D.name),V.set(D,j))}function Pt(D,lt){const j=l.get(lt).get(D);o.get(lt)!==j&&(i.uniformBlockBinding(lt,j,D.__bindingPointIndex),o.set(lt,j))}function Qt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),c={},W=null,rt={},h={},u=new WeakMap,d=[],f=null,g=!1,v=null,p=null,m=null,b=null,S=null,T=null,L=null,C=new St(0,0,0),A=0,R=!1,k=null,_=null,M=null,F=null,N=null,Lt.set(0,0,i.canvas.width,i.canvas.height),It.set(0,0,i.canvas.width,i.canvas.height),r.reset(),s.reset(),a.reset()}return{buffers:{color:r,depth:s,stencil:a},enable:gt,disable:ht,bindFramebuffer:Ct,drawBuffers:Et,useProgram:Bt,setBlending:P,setMaterial:Le,setFlipSided:Ft,setCullFace:kt,setLineWidth:bt,setPolygonOffset:te,setScissorTest:Rt,activeTexture:w,bindTexture:x,unbindTexture:z,compressedTexImage2D:Z,compressedTexImage3D:$,texImage2D:dt,texImage3D:wt,updateUBOMapping:Ot,uniformBlockBinding:Pt,texStorage2D:Vt,texStorage3D:Q,texSubImage2D:q,texSubImage3D:vt,compressedTexSubImage2D:it,compressedTexSubImage3D:ut,scissor:At,viewport:ft,reset:Qt}}function Oo(i,t,e,n){const r=Kp(n);switch(e){case il:return i*t;case sl:return i*t;case al:return i*t*2;case ol:return i*t/r.components*r.byteLength;case _a:return i*t/r.components*r.byteLength;case ll:return i*t*2/r.components*r.byteLength;case va:return i*t*2/r.components*r.byteLength;case rl:return i*t*3/r.components*r.byteLength;case qe:return i*t*4/r.components*r.byteLength;case xa:return i*t*4/r.components*r.byteLength;case vr:case xr:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case Mr:case Sr:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Hs:case ks:return Math.max(i,16)*Math.max(t,8)/4;case zs:case Gs:return Math.max(i,8)*Math.max(t,8)/2;case Vs:case Ws:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case Xs:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Ys:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case qs:return Math.floor((i+4)/5)*Math.floor((t+3)/4)*16;case Zs:return Math.floor((i+4)/5)*Math.floor((t+4)/5)*16;case Ks:return Math.floor((i+5)/6)*Math.floor((t+4)/5)*16;case js:return Math.floor((i+5)/6)*Math.floor((t+5)/6)*16;case $s:return Math.floor((i+7)/8)*Math.floor((t+4)/5)*16;case Js:return Math.floor((i+7)/8)*Math.floor((t+5)/6)*16;case Qs:return Math.floor((i+7)/8)*Math.floor((t+7)/8)*16;case ta:return Math.floor((i+9)/10)*Math.floor((t+4)/5)*16;case ea:return Math.floor((i+9)/10)*Math.floor((t+5)/6)*16;case na:return Math.floor((i+9)/10)*Math.floor((t+7)/8)*16;case ia:return Math.floor((i+9)/10)*Math.floor((t+9)/10)*16;case ra:return Math.floor((i+11)/12)*Math.floor((t+9)/10)*16;case sa:return Math.floor((i+11)/12)*Math.floor((t+11)/12)*16;case yr:case aa:case oa:return Math.ceil(i/4)*Math.ceil(t/4)*16;case cl:case la:return Math.ceil(i/4)*Math.ceil(t/4)*8;case ca:case ha:return Math.ceil(i/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function Kp(i){switch(i){case pn:case tl:return{byteLength:1,components:1};case Ii:case el:case Ye:return{byteLength:2,components:1};case ma:case ga:return{byteLength:2,components:4};case Vn:case pa:case Be:return{byteLength:4,components:1};case nl:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function jp(i,t,e,n,r,s,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new st,h=new WeakMap;let u;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(w,x){return f?new OffscreenCanvas(w,x):Fi("canvas")}function v(w,x,z){let Z=1;const $=Rt(w);if(($.width>z||$.height>z)&&(Z=z/Math.max($.width,$.height)),Z<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const q=Math.floor(Z*$.width),vt=Math.floor(Z*$.height);u===void 0&&(u=g(q,vt));const it=x?g(q,vt):u;return it.width=q,it.height=vt,it.getContext("2d").drawImage(w,0,0,q,vt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+q+"x"+vt+")."),it}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),w;return w}function p(w){return w.generateMipmaps&&w.minFilter!==Pe&&w.minFilter!==xe}function m(w){i.generateMipmap(w)}function b(w,x,z,Z,$=!1){if(w!==null){if(i[w]!==void 0)return i[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let q=x;if(x===i.RED&&(z===i.FLOAT&&(q=i.R32F),z===i.HALF_FLOAT&&(q=i.R16F),z===i.UNSIGNED_BYTE&&(q=i.R8)),x===i.RED_INTEGER&&(z===i.UNSIGNED_BYTE&&(q=i.R8UI),z===i.UNSIGNED_SHORT&&(q=i.R16UI),z===i.UNSIGNED_INT&&(q=i.R32UI),z===i.BYTE&&(q=i.R8I),z===i.SHORT&&(q=i.R16I),z===i.INT&&(q=i.R32I)),x===i.RG&&(z===i.FLOAT&&(q=i.RG32F),z===i.HALF_FLOAT&&(q=i.RG16F),z===i.UNSIGNED_BYTE&&(q=i.RG8)),x===i.RG_INTEGER&&(z===i.UNSIGNED_BYTE&&(q=i.RG8UI),z===i.UNSIGNED_SHORT&&(q=i.RG16UI),z===i.UNSIGNED_INT&&(q=i.RG32UI),z===i.BYTE&&(q=i.RG8I),z===i.SHORT&&(q=i.RG16I),z===i.INT&&(q=i.RG32I)),x===i.RGB_INTEGER&&(z===i.UNSIGNED_BYTE&&(q=i.RGB8UI),z===i.UNSIGNED_SHORT&&(q=i.RGB16UI),z===i.UNSIGNED_INT&&(q=i.RGB32UI),z===i.BYTE&&(q=i.RGB8I),z===i.SHORT&&(q=i.RGB16I),z===i.INT&&(q=i.RGB32I)),x===i.RGBA_INTEGER&&(z===i.UNSIGNED_BYTE&&(q=i.RGBA8UI),z===i.UNSIGNED_SHORT&&(q=i.RGBA16UI),z===i.UNSIGNED_INT&&(q=i.RGBA32UI),z===i.BYTE&&(q=i.RGBA8I),z===i.SHORT&&(q=i.RGBA16I),z===i.INT&&(q=i.RGBA32I)),x===i.RGB&&z===i.UNSIGNED_INT_5_9_9_9_REV&&(q=i.RGB9_E5),x===i.RGBA){const vt=$?Ar:Zt.getTransfer(Z);z===i.FLOAT&&(q=i.RGBA32F),z===i.HALF_FLOAT&&(q=i.RGBA16F),z===i.UNSIGNED_BYTE&&(q=vt===ne?i.SRGB8_ALPHA8:i.RGBA8),z===i.UNSIGNED_SHORT_4_4_4_4&&(q=i.RGBA4),z===i.UNSIGNED_SHORT_5_5_5_1&&(q=i.RGB5_A1)}return(q===i.R16F||q===i.R32F||q===i.RG16F||q===i.RG32F||q===i.RGBA16F||q===i.RGBA32F)&&t.get("EXT_color_buffer_float"),q}function S(w,x){let z;return w?x===null||x===Vn||x===gi?z=i.DEPTH24_STENCIL8:x===Be?z=i.DEPTH32F_STENCIL8:x===Ii&&(z=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===Vn||x===gi?z=i.DEPTH_COMPONENT24:x===Be?z=i.DEPTH_COMPONENT32F:x===Ii&&(z=i.DEPTH_COMPONENT16),z}function T(w,x){return p(w)===!0||w.isFramebufferTexture&&w.minFilter!==Pe&&w.minFilter!==xe?Math.log2(Math.max(x.width,x.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?x.mipmaps.length:1}function L(w){const x=w.target;x.removeEventListener("dispose",L),A(x),x.isVideoTexture&&h.delete(x)}function C(w){const x=w.target;x.removeEventListener("dispose",C),k(x)}function A(w){const x=n.get(w);if(x.__webglInit===void 0)return;const z=w.source,Z=d.get(z);if(Z){const $=Z[x.__cacheKey];$.usedTimes--,$.usedTimes===0&&R(w),Object.keys(Z).length===0&&d.delete(z)}n.remove(w)}function R(w){const x=n.get(w);i.deleteTexture(x.__webglTexture);const z=w.source,Z=d.get(z);delete Z[x.__cacheKey],a.memory.textures--}function k(w){const x=n.get(w);if(w.depthTexture&&w.depthTexture.dispose(),w.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(x.__webglFramebuffer[Z]))for(let $=0;$<x.__webglFramebuffer[Z].length;$++)i.deleteFramebuffer(x.__webglFramebuffer[Z][$]);else i.deleteFramebuffer(x.__webglFramebuffer[Z]);x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer[Z])}else{if(Array.isArray(x.__webglFramebuffer))for(let Z=0;Z<x.__webglFramebuffer.length;Z++)i.deleteFramebuffer(x.__webglFramebuffer[Z]);else i.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&i.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let Z=0;Z<x.__webglColorRenderbuffer.length;Z++)x.__webglColorRenderbuffer[Z]&&i.deleteRenderbuffer(x.__webglColorRenderbuffer[Z]);x.__webglDepthRenderbuffer&&i.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const z=w.textures;for(let Z=0,$=z.length;Z<$;Z++){const q=n.get(z[Z]);q.__webglTexture&&(i.deleteTexture(q.__webglTexture),a.memory.textures--),n.remove(z[Z])}n.remove(w)}let _=0;function M(){_=0}function F(){const w=_;return w>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+r.maxTextures),_+=1,w}function N(w){const x=[];return x.push(w.wrapS),x.push(w.wrapT),x.push(w.wrapR||0),x.push(w.magFilter),x.push(w.minFilter),x.push(w.anisotropy),x.push(w.internalFormat),x.push(w.format),x.push(w.type),x.push(w.generateMipmaps),x.push(w.premultiplyAlpha),x.push(w.flipY),x.push(w.unpackAlignment),x.push(w.colorSpace),x.join()}function B(w,x){const z=n.get(w);if(w.isVideoTexture&&bt(w),w.isRenderTargetTexture===!1&&w.version>0&&z.__version!==w.version){const Z=w.image;if(Z===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{It(z,w,x);return}}e.bindTexture(i.TEXTURE_2D,z.__webglTexture,i.TEXTURE0+x)}function X(w,x){const z=n.get(w);if(w.version>0&&z.__version!==w.version){It(z,w,x);return}e.bindTexture(i.TEXTURE_2D_ARRAY,z.__webglTexture,i.TEXTURE0+x)}function O(w,x){const z=n.get(w);if(w.version>0&&z.__version!==w.version){It(z,w,x);return}e.bindTexture(i.TEXTURE_3D,z.__webglTexture,i.TEXTURE0+x)}function K(w,x){const z=n.get(w);if(w.version>0&&z.__version!==w.version){Y(z,w,x);return}e.bindTexture(i.TEXTURE_CUBE_MAP,z.__webglTexture,i.TEXTURE0+x)}const W={[Te]:i.REPEAT,[hn]:i.CLAMP_TO_EDGE,[Bs]:i.MIRRORED_REPEAT},rt={[Pe]:i.NEAREST,[_c]:i.NEAREST_MIPMAP_NEAREST,[Xi]:i.NEAREST_MIPMAP_LINEAR,[xe]:i.LINEAR,[Xr]:i.LINEAR_MIPMAP_NEAREST,[bn]:i.LINEAR_MIPMAP_LINEAR},nt={[Sc]:i.NEVER,[Ac]:i.ALWAYS,[yc]:i.LESS,[ul]:i.LEQUAL,[Ec]:i.EQUAL,[wc]:i.GEQUAL,[Tc]:i.GREATER,[bc]:i.NOTEQUAL};function mt(w,x){if(x.type===Be&&t.has("OES_texture_float_linear")===!1&&(x.magFilter===xe||x.magFilter===Xr||x.magFilter===Xi||x.magFilter===bn||x.minFilter===xe||x.minFilter===Xr||x.minFilter===Xi||x.minFilter===bn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(w,i.TEXTURE_WRAP_S,W[x.wrapS]),i.texParameteri(w,i.TEXTURE_WRAP_T,W[x.wrapT]),(w===i.TEXTURE_3D||w===i.TEXTURE_2D_ARRAY)&&i.texParameteri(w,i.TEXTURE_WRAP_R,W[x.wrapR]),i.texParameteri(w,i.TEXTURE_MAG_FILTER,rt[x.magFilter]),i.texParameteri(w,i.TEXTURE_MIN_FILTER,rt[x.minFilter]),x.compareFunction&&(i.texParameteri(w,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(w,i.TEXTURE_COMPARE_FUNC,nt[x.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===Pe||x.minFilter!==Xi&&x.minFilter!==bn||x.type===Be&&t.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||n.get(x).__currentAnisotropy){const z=t.get("EXT_texture_filter_anisotropic");i.texParameterf(w,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,r.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy}}}function Lt(w,x){let z=!1;w.__webglInit===void 0&&(w.__webglInit=!0,x.addEventListener("dispose",L));const Z=x.source;let $=d.get(Z);$===void 0&&($={},d.set(Z,$));const q=N(x);if(q!==w.__cacheKey){$[q]===void 0&&($[q]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,z=!0),$[q].usedTimes++;const vt=$[w.__cacheKey];vt!==void 0&&($[w.__cacheKey].usedTimes--,vt.usedTimes===0&&R(x)),w.__cacheKey=q,w.__webglTexture=$[q].texture}return z}function It(w,x,z){let Z=i.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(Z=i.TEXTURE_2D_ARRAY),x.isData3DTexture&&(Z=i.TEXTURE_3D);const $=Lt(w,x),q=x.source;e.bindTexture(Z,w.__webglTexture,i.TEXTURE0+z);const vt=n.get(q);if(q.version!==vt.__version||$===!0){e.activeTexture(i.TEXTURE0+z);const it=Zt.getPrimaries(Zt.workingColorSpace),ut=x.colorSpace===Tn?null:Zt.getPrimaries(x.colorSpace),Vt=x.colorSpace===Tn||it===ut?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Vt);let Q=v(x.image,!1,r.maxTextureSize);Q=te(x,Q);const dt=s.convert(x.format,x.colorSpace),wt=s.convert(x.type);let At=b(x.internalFormat,dt,wt,x.colorSpace,x.isVideoTexture);mt(Z,x);let ft;const Ot=x.mipmaps,Pt=x.isVideoTexture!==!0,Qt=vt.__version===void 0||$===!0,D=q.dataReady,lt=T(x,Q);if(x.isDepthTexture)At=S(x.format===_i,x.type),Qt&&(Pt?e.texStorage2D(i.TEXTURE_2D,1,At,Q.width,Q.height):e.texImage2D(i.TEXTURE_2D,0,At,Q.width,Q.height,0,dt,wt,null));else if(x.isDataTexture)if(Ot.length>0){Pt&&Qt&&e.texStorage2D(i.TEXTURE_2D,lt,At,Ot[0].width,Ot[0].height);for(let V=0,j=Ot.length;V<j;V++)ft=Ot[V],Pt?D&&e.texSubImage2D(i.TEXTURE_2D,V,0,0,ft.width,ft.height,dt,wt,ft.data):e.texImage2D(i.TEXTURE_2D,V,At,ft.width,ft.height,0,dt,wt,ft.data);x.generateMipmaps=!1}else Pt?(Qt&&e.texStorage2D(i.TEXTURE_2D,lt,At,Q.width,Q.height),D&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,Q.width,Q.height,dt,wt,Q.data)):e.texImage2D(i.TEXTURE_2D,0,At,Q.width,Q.height,0,dt,wt,Q.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){Pt&&Qt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,lt,At,Ot[0].width,Ot[0].height,Q.depth);for(let V=0,j=Ot.length;V<j;V++)if(ft=Ot[V],x.format!==qe)if(dt!==null)if(Pt){if(D)if(x.layerUpdates.size>0){const at=Oo(ft.width,ft.height,x.format,x.type);for(const ct of x.layerUpdates){const Ht=ft.data.subarray(ct*at/ft.data.BYTES_PER_ELEMENT,(ct+1)*at/ft.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,V,0,0,ct,ft.width,ft.height,1,dt,Ht,0,0)}x.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,V,0,0,0,ft.width,ft.height,Q.depth,dt,ft.data,0,0)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,V,At,ft.width,ft.height,Q.depth,0,ft.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Pt?D&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,V,0,0,0,ft.width,ft.height,Q.depth,dt,wt,ft.data):e.texImage3D(i.TEXTURE_2D_ARRAY,V,At,ft.width,ft.height,Q.depth,0,dt,wt,ft.data)}else{Pt&&Qt&&e.texStorage2D(i.TEXTURE_2D,lt,At,Ot[0].width,Ot[0].height);for(let V=0,j=Ot.length;V<j;V++)ft=Ot[V],x.format!==qe?dt!==null?Pt?D&&e.compressedTexSubImage2D(i.TEXTURE_2D,V,0,0,ft.width,ft.height,dt,ft.data):e.compressedTexImage2D(i.TEXTURE_2D,V,At,ft.width,ft.height,0,ft.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Pt?D&&e.texSubImage2D(i.TEXTURE_2D,V,0,0,ft.width,ft.height,dt,wt,ft.data):e.texImage2D(i.TEXTURE_2D,V,At,ft.width,ft.height,0,dt,wt,ft.data)}else if(x.isDataArrayTexture)if(Pt){if(Qt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,lt,At,Q.width,Q.height,Q.depth),D)if(x.layerUpdates.size>0){const V=Oo(Q.width,Q.height,x.format,x.type);for(const j of x.layerUpdates){const at=Q.data.subarray(j*V/Q.data.BYTES_PER_ELEMENT,(j+1)*V/Q.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,j,Q.width,Q.height,1,dt,wt,at)}x.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,dt,wt,Q.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,At,Q.width,Q.height,Q.depth,0,dt,wt,Q.data);else if(x.isData3DTexture)Pt?(Qt&&e.texStorage3D(i.TEXTURE_3D,lt,At,Q.width,Q.height,Q.depth),D&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,dt,wt,Q.data)):e.texImage3D(i.TEXTURE_3D,0,At,Q.width,Q.height,Q.depth,0,dt,wt,Q.data);else if(x.isFramebufferTexture){if(Qt)if(Pt)e.texStorage2D(i.TEXTURE_2D,lt,At,Q.width,Q.height);else{let V=Q.width,j=Q.height;for(let at=0;at<lt;at++)e.texImage2D(i.TEXTURE_2D,at,At,V,j,0,dt,wt,null),V>>=1,j>>=1}}else if(Ot.length>0){if(Pt&&Qt){const V=Rt(Ot[0]);e.texStorage2D(i.TEXTURE_2D,lt,At,V.width,V.height)}for(let V=0,j=Ot.length;V<j;V++)ft=Ot[V],Pt?D&&e.texSubImage2D(i.TEXTURE_2D,V,0,0,dt,wt,ft):e.texImage2D(i.TEXTURE_2D,V,At,dt,wt,ft);x.generateMipmaps=!1}else if(Pt){if(Qt){const V=Rt(Q);e.texStorage2D(i.TEXTURE_2D,lt,At,V.width,V.height)}D&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,dt,wt,Q)}else e.texImage2D(i.TEXTURE_2D,0,At,dt,wt,Q);p(x)&&m(Z),vt.__version=q.version,x.onUpdate&&x.onUpdate(x)}w.__version=x.version}function Y(w,x,z){if(x.image.length!==6)return;const Z=Lt(w,x),$=x.source;e.bindTexture(i.TEXTURE_CUBE_MAP,w.__webglTexture,i.TEXTURE0+z);const q=n.get($);if($.version!==q.__version||Z===!0){e.activeTexture(i.TEXTURE0+z);const vt=Zt.getPrimaries(Zt.workingColorSpace),it=x.colorSpace===Tn?null:Zt.getPrimaries(x.colorSpace),ut=x.colorSpace===Tn||vt===it?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ut);const Vt=x.isCompressedTexture||x.image[0].isCompressedTexture,Q=x.image[0]&&x.image[0].isDataTexture,dt=[];for(let j=0;j<6;j++)!Vt&&!Q?dt[j]=v(x.image[j],!0,r.maxCubemapSize):dt[j]=Q?x.image[j].image:x.image[j],dt[j]=te(x,dt[j]);const wt=dt[0],At=s.convert(x.format,x.colorSpace),ft=s.convert(x.type),Ot=b(x.internalFormat,At,ft,x.colorSpace),Pt=x.isVideoTexture!==!0,Qt=q.__version===void 0||Z===!0,D=$.dataReady;let lt=T(x,wt);mt(i.TEXTURE_CUBE_MAP,x);let V;if(Vt){Pt&&Qt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,lt,Ot,wt.width,wt.height);for(let j=0;j<6;j++){V=dt[j].mipmaps;for(let at=0;at<V.length;at++){const ct=V[at];x.format!==qe?At!==null?Pt?D&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,at,0,0,ct.width,ct.height,At,ct.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,at,Ot,ct.width,ct.height,0,ct.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Pt?D&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,at,0,0,ct.width,ct.height,At,ft,ct.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,at,Ot,ct.width,ct.height,0,At,ft,ct.data)}}}else{if(V=x.mipmaps,Pt&&Qt){V.length>0&&lt++;const j=Rt(dt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,lt,Ot,j.width,j.height)}for(let j=0;j<6;j++)if(Q){Pt?D&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,dt[j].width,dt[j].height,At,ft,dt[j].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Ot,dt[j].width,dt[j].height,0,At,ft,dt[j].data);for(let at=0;at<V.length;at++){const Ht=V[at].image[j].image;Pt?D&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,at+1,0,0,Ht.width,Ht.height,At,ft,Ht.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,at+1,Ot,Ht.width,Ht.height,0,At,ft,Ht.data)}}else{Pt?D&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,At,ft,dt[j]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Ot,At,ft,dt[j]);for(let at=0;at<V.length;at++){const ct=V[at];Pt?D&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,at+1,0,0,At,ft,ct.image[j]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,at+1,Ot,At,ft,ct.image[j])}}}p(x)&&m(i.TEXTURE_CUBE_MAP),q.__version=$.version,x.onUpdate&&x.onUpdate(x)}w.__version=x.version}function J(w,x,z,Z,$,q){const vt=s.convert(z.format,z.colorSpace),it=s.convert(z.type),ut=b(z.internalFormat,vt,it,z.colorSpace);if(!n.get(x).__hasExternalTextures){const Q=Math.max(1,x.width>>q),dt=Math.max(1,x.height>>q);$===i.TEXTURE_3D||$===i.TEXTURE_2D_ARRAY?e.texImage3D($,q,ut,Q,dt,x.depth,0,vt,it,null):e.texImage2D($,q,ut,Q,dt,0,vt,it,null)}e.bindFramebuffer(i.FRAMEBUFFER,w),kt(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Z,$,n.get(z).__webglTexture,0,Ft(x)):($===i.TEXTURE_2D||$>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Z,$,n.get(z).__webglTexture,q),e.bindFramebuffer(i.FRAMEBUFFER,null)}function gt(w,x,z){if(i.bindRenderbuffer(i.RENDERBUFFER,w),x.depthBuffer){const Z=x.depthTexture,$=Z&&Z.isDepthTexture?Z.type:null,q=S(x.stencilBuffer,$),vt=x.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,it=Ft(x);kt(x)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,it,q,x.width,x.height):z?i.renderbufferStorageMultisample(i.RENDERBUFFER,it,q,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,q,x.width,x.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,vt,i.RENDERBUFFER,w)}else{const Z=x.textures;for(let $=0;$<Z.length;$++){const q=Z[$],vt=s.convert(q.format,q.colorSpace),it=s.convert(q.type),ut=b(q.internalFormat,vt,it,q.colorSpace),Vt=Ft(x);z&&kt(x)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Vt,ut,x.width,x.height):kt(x)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Vt,ut,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,ut,x.width,x.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ht(w,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,w),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(x.depthTexture).__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),B(x.depthTexture,0);const Z=n.get(x.depthTexture).__webglTexture,$=Ft(x);if(x.depthTexture.format===ui)kt(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Z,0,$):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Z,0);else if(x.depthTexture.format===_i)kt(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Z,0,$):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function Ct(w){const x=n.get(w),z=w.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==w.depthTexture){const Z=w.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),Z){const $=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,Z.removeEventListener("dispose",$)};Z.addEventListener("dispose",$),x.__depthDisposeCallback=$}x.__boundDepthTexture=Z}if(w.depthTexture&&!x.__autoAllocateDepthBuffer){if(z)throw new Error("target.depthTexture not supported in Cube render targets");ht(x.__webglFramebuffer,w)}else if(z){x.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)if(e.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[Z]),x.__webglDepthbuffer[Z]===void 0)x.__webglDepthbuffer[Z]=i.createRenderbuffer(),gt(x.__webglDepthbuffer[Z],w,!1);else{const $=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,q=x.__webglDepthbuffer[Z];i.bindRenderbuffer(i.RENDERBUFFER,q),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,q)}}else if(e.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=i.createRenderbuffer(),gt(x.__webglDepthbuffer,w,!1);else{const Z=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,$=x.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,$),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,$)}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Et(w,x,z){const Z=n.get(w);x!==void 0&&J(Z.__webglFramebuffer,w,w.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),z!==void 0&&Ct(w)}function Bt(w){const x=w.texture,z=n.get(w),Z=n.get(x);w.addEventListener("dispose",C);const $=w.textures,q=w.isWebGLCubeRenderTarget===!0,vt=$.length>1;if(vt||(Z.__webglTexture===void 0&&(Z.__webglTexture=i.createTexture()),Z.__version=x.version,a.memory.textures++),q){z.__webglFramebuffer=[];for(let it=0;it<6;it++)if(x.mipmaps&&x.mipmaps.length>0){z.__webglFramebuffer[it]=[];for(let ut=0;ut<x.mipmaps.length;ut++)z.__webglFramebuffer[it][ut]=i.createFramebuffer()}else z.__webglFramebuffer[it]=i.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){z.__webglFramebuffer=[];for(let it=0;it<x.mipmaps.length;it++)z.__webglFramebuffer[it]=i.createFramebuffer()}else z.__webglFramebuffer=i.createFramebuffer();if(vt)for(let it=0,ut=$.length;it<ut;it++){const Vt=n.get($[it]);Vt.__webglTexture===void 0&&(Vt.__webglTexture=i.createTexture(),a.memory.textures++)}if(w.samples>0&&kt(w)===!1){z.__webglMultisampledFramebuffer=i.createFramebuffer(),z.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let it=0;it<$.length;it++){const ut=$[it];z.__webglColorRenderbuffer[it]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,z.__webglColorRenderbuffer[it]);const Vt=s.convert(ut.format,ut.colorSpace),Q=s.convert(ut.type),dt=b(ut.internalFormat,Vt,Q,ut.colorSpace,w.isXRRenderTarget===!0),wt=Ft(w);i.renderbufferStorageMultisample(i.RENDERBUFFER,wt,dt,w.width,w.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+it,i.RENDERBUFFER,z.__webglColorRenderbuffer[it])}i.bindRenderbuffer(i.RENDERBUFFER,null),w.depthBuffer&&(z.__webglDepthRenderbuffer=i.createRenderbuffer(),gt(z.__webglDepthRenderbuffer,w,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(q){e.bindTexture(i.TEXTURE_CUBE_MAP,Z.__webglTexture),mt(i.TEXTURE_CUBE_MAP,x);for(let it=0;it<6;it++)if(x.mipmaps&&x.mipmaps.length>0)for(let ut=0;ut<x.mipmaps.length;ut++)J(z.__webglFramebuffer[it][ut],w,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+it,ut);else J(z.__webglFramebuffer[it],w,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+it,0);p(x)&&m(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(vt){for(let it=0,ut=$.length;it<ut;it++){const Vt=$[it],Q=n.get(Vt);e.bindTexture(i.TEXTURE_2D,Q.__webglTexture),mt(i.TEXTURE_2D,Vt),J(z.__webglFramebuffer,w,Vt,i.COLOR_ATTACHMENT0+it,i.TEXTURE_2D,0),p(Vt)&&m(i.TEXTURE_2D)}e.unbindTexture()}else{let it=i.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(it=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(it,Z.__webglTexture),mt(it,x),x.mipmaps&&x.mipmaps.length>0)for(let ut=0;ut<x.mipmaps.length;ut++)J(z.__webglFramebuffer[ut],w,x,i.COLOR_ATTACHMENT0,it,ut);else J(z.__webglFramebuffer,w,x,i.COLOR_ATTACHMENT0,it,0);p(x)&&m(it),e.unbindTexture()}w.depthBuffer&&Ct(w)}function jt(w){const x=w.textures;for(let z=0,Z=x.length;z<Z;z++){const $=x[z];if(p($)){const q=w.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,vt=n.get($).__webglTexture;e.bindTexture(q,vt),m(q),e.unbindTexture()}}}const zt=[],P=[];function Le(w){if(w.samples>0){if(kt(w)===!1){const x=w.textures,z=w.width,Z=w.height;let $=i.COLOR_BUFFER_BIT;const q=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,vt=n.get(w),it=x.length>1;if(it)for(let ut=0;ut<x.length;ut++)e.bindFramebuffer(i.FRAMEBUFFER,vt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,vt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,vt.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,vt.__webglFramebuffer);for(let ut=0;ut<x.length;ut++){if(w.resolveDepthBuffer&&(w.depthBuffer&&($|=i.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&($|=i.STENCIL_BUFFER_BIT)),it){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,vt.__webglColorRenderbuffer[ut]);const Vt=n.get(x[ut]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Vt,0)}i.blitFramebuffer(0,0,z,Z,0,0,z,Z,$,i.NEAREST),l===!0&&(zt.length=0,P.length=0,zt.push(i.COLOR_ATTACHMENT0+ut),w.depthBuffer&&w.resolveDepthBuffer===!1&&(zt.push(q),P.push(q),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,P)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,zt))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),it)for(let ut=0;ut<x.length;ut++){e.bindFramebuffer(i.FRAMEBUFFER,vt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.RENDERBUFFER,vt.__webglColorRenderbuffer[ut]);const Vt=n.get(x[ut]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,vt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.TEXTURE_2D,Vt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,vt.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&l){const x=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[x])}}}function Ft(w){return Math.min(r.maxSamples,w.samples)}function kt(w){const x=n.get(w);return w.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function bt(w){const x=a.render.frame;h.get(w)!==x&&(h.set(w,x),w.update())}function te(w,x){const z=w.colorSpace,Z=w.format,$=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||z!==gn&&z!==Tn&&(Zt.getTransfer(z)===ne?(Z!==qe||$!==pn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",z)),x}function Rt(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(c.width=w.naturalWidth||w.width,c.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(c.width=w.displayWidth,c.height=w.displayHeight):(c.width=w.width,c.height=w.height),c}this.allocateTextureUnit=F,this.resetTextureUnits=M,this.setTexture2D=B,this.setTexture2DArray=X,this.setTexture3D=O,this.setTextureCube=K,this.rebindTextures=Et,this.setupRenderTarget=Bt,this.updateRenderTargetMipmap=jt,this.updateMultisampleRenderTarget=Le,this.setupDepthRenderbuffer=Ct,this.setupFrameBufferTexture=J,this.useMultisampledRTT=kt}function $p(i,t){function e(n,r=Tn){let s;const a=Zt.getTransfer(r);if(n===pn)return i.UNSIGNED_BYTE;if(n===ma)return i.UNSIGNED_SHORT_4_4_4_4;if(n===ga)return i.UNSIGNED_SHORT_5_5_5_1;if(n===nl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===tl)return i.BYTE;if(n===el)return i.SHORT;if(n===Ii)return i.UNSIGNED_SHORT;if(n===pa)return i.INT;if(n===Vn)return i.UNSIGNED_INT;if(n===Be)return i.FLOAT;if(n===Ye)return i.HALF_FLOAT;if(n===il)return i.ALPHA;if(n===rl)return i.RGB;if(n===qe)return i.RGBA;if(n===sl)return i.LUMINANCE;if(n===al)return i.LUMINANCE_ALPHA;if(n===ui)return i.DEPTH_COMPONENT;if(n===_i)return i.DEPTH_STENCIL;if(n===ol)return i.RED;if(n===_a)return i.RED_INTEGER;if(n===ll)return i.RG;if(n===va)return i.RG_INTEGER;if(n===xa)return i.RGBA_INTEGER;if(n===vr||n===xr||n===Mr||n===Sr)if(a===ne)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===vr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===xr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Mr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Sr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===vr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===xr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Mr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Sr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===zs||n===Hs||n===Gs||n===ks)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===zs)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Hs)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Gs)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ks)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Vs||n===Ws||n===Xs)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Vs||n===Ws)return a===ne?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Xs)return a===ne?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Ys||n===qs||n===Zs||n===Ks||n===js||n===$s||n===Js||n===Qs||n===ta||n===ea||n===na||n===ia||n===ra||n===sa)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Ys)return a===ne?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===qs)return a===ne?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Zs)return a===ne?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Ks)return a===ne?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===js)return a===ne?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===$s)return a===ne?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Js)return a===ne?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Qs)return a===ne?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===ta)return a===ne?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===ea)return a===ne?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===na)return a===ne?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ia)return a===ne?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ra)return a===ne?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===sa)return a===ne?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===yr||n===aa||n===oa)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(n===yr)return a===ne?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===aa)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===oa)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===cl||n===la||n===ca||n===ha)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(n===yr)return s.COMPRESSED_RED_RGTC1_EXT;if(n===la)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ca)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===ha)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===gi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}class Jp extends be{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class dn extends me{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Qp={type:"move"};class xs{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new dn,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new dn,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new E,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new E),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new dn,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new E,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new E),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let r=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){a=!0;for(const v of t.hand.values()){const p=e.getJointPose(v,n),m=this._getHandJoint(c,v);p!==null&&(m.matrix.fromArray(p.transform.matrix),m.matrix.decompose(m.position,m.rotation,m.scale),m.matrixWorldNeedsUpdate=!0,m.jointRadius=p.radius),m.visible=p!==null}const h=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],d=h.position.distanceTo(u.position),f=.02,g=.005;c.inputState.pinching&&d>f+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&d<=f-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(s=e.getPose(t.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=e.getPose(t.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Qp)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new dn;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const tm=`
void main() {
...
`;continue}if((O=X.match(_))&&(B.gamma=parseFloat(O[1])),(O=X.match(M))&&(B.exposure=parseFloat(O[1])),(O=X.match(F))&&(B.valid|=2,B.format=O[1]),(O=X.match(N))&&(B.valid|=4,B.height=parseInt(O[1],10),B.width=parseInt(O[2],10)),B.valid&2&&B.valid&4)break}return B.valid&2||a(3,"missing format specifier"),B.valid&4||a(3,"missing image size specifier"),B},f=function(R,k,_){const M=k;if(M<8||M>32767||R[0]!==2||R[1]!==2||R[2]&128)return new Uint8Array(R);M!==(R[2]<<8|R[3])&&a(3,"wrong scanline width");const F=new Uint8Array(4*k*_);F.length||a(4,"unable to allocate buffer space");let N=0,B=0;const X=4*M,O=new Uint8Array(4),K=new Uint8Array(X);let W=_;for(;W>0&&B<R.byteLength;){B+4>R.byteLength&&a(1),O[0]=R[B++],O[1]=R[B++],O[2]=R[B++],O[3]=R[B++],(O[0]!=2||O[1]!=2||(O[2]<<8|O[3])!=M)&&a(3,"bad rgbe scanline format");let rt=0,nt;for(;rt<X&&B<R.byteLength;){nt=R[B++];const Lt=nt>128;if(Lt&&(nt-=128),(nt===0||rt+nt>X)&&a(3,"bad scanline data"),Lt){const It=R[B++];for(let Y=0;Y<nt;Y++)K[rt++]=It}else K.set(R.subarray(B,B+nt),rt),rt+=nt,B+=nt}const mt=M;for(let Lt=0;Lt<mt;Lt++){let It=0;F[N]=K[Lt+It],It+=M,F[N+1]=K[Lt+It],It+=M,F[N+2]=K[Lt+It],It+=M,F[N+3]=K[Lt+It],N+=4}W--}return F},g=function(R,k,_,M){const F=R[k+3],N=Math.pow(2,F-128)/255;_[M+0]=R[k+0]*N,_[M+1]=R[k+1]*N,_[M+2]=R[k+2]*N,_[M+3]=1},v=function(R,k,_,M){const F=R[k+3],N=Math.pow(2,F-128)/255;_[M+0]=tr.toHalfFloat(Math.min(R[k+0]*N,65504)),_[M+1]=tr.toHalfFloat(Math.min(R[k+1]*N,65504)),_[M+2]=tr.toHalfFloat(Math.min(R[k+2]*N,65504)),_[M+3]=tr.toHalfFloat(1)},p=new Uint8Array(t);p.pos=0;const m=d(p),b=m.width,S=m.height,T=f(p.subarray(p.pos),b,S);let L,C,A;switch(this.type){case Be:A=T.length/4;const R=new Float32Array(A*4);for(let _=0;_<A;_++)g(T,_*4,R,_*4);L=R,C=Be;break;case Ye:A=T.length/4;const k=new Uint16Array(A*4);for(let _=0;_<A;_++)v(T,_*4,k,_*4);L=k,C=Ye;break;default:throw new Error("THREE.RGBELoader: Unsupported type: "+this.type)}return{width:b,height:S,data:L,header:m.string,gamma:m.gamma,exposure:m.exposure,type:C}}setDataType(t){return this.type=t,this}load(t,e,n,r){function s(a,o){switch(a.type){case Be:case Ye:a.colorSpace=gn,a.minFilter=xe,a.magFilter=xe,a.generateMipmaps=!1,a.flipY=!0;break}e&&e(a,o)}return super.load(t,s,n,r)}}class Oi extends ie{constructor(t,e={}){super(t),this.isReflector=!0,this.type="Reflector",this.camera=new be;const n=this,r=e.color!==void 0?new St(e.color):new St(8355711),s=e.textureWidth||512,a=e.textureHeight||512,o=e.clipBias||0,l=e.shader||Oi.ReflectorShader,c=e.multisample!==void 0?e.multisample:4,h=new We,u=new E,d=new E,f=new E,g=new Nt,v=new E(0,0,-1),p=new Gt,m=new E,b=new E,S=new Gt,T=new Nt,L=this.camera,C=new mn(s,a,{samples:c,type:Ye}),A=new ze({name:l.name!==void 0?l.name:"unspecified",uniforms:Hi.clone(l.uniforms),fragmentShader:l.fragmentShader,vertexShader:l.vertexShader});A.uniforms.tDiffuse.value=C.texture,A.uniforms.color.value=r,A.uniforms.textureMatrix.value=T,this.material=A,this.onBeforeRender=function(R,k,_){if(d.setFromMatrixPosition(n.matrixWorld),f.setFromMatrixPosition(_.matrixWorld),g.extractRotation(n.matrixWorld),u.set(0,0,1),u.applyMatrix4(g),m.subVectors(d,f),m.dot(u)>0)return;m.reflect(u).negate(),m.add(d),g.extractRotation(_.matrixWorld),v.set(0,0,-1),v.applyMatrix4(g),v.add(f),b.subVectors(d,v),b.reflect(u).negate(),b.add(d),L.position.copy(m),L.up.set(0,1,0),L.up.applyMatrix4(g),L.up.reflect(u),L.lookAt(b),L.far=_.far,L.updateMatrixWorld(),L.projectionMatrix.copy(_.projectionMatrix),T.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),T.multiply(L.projectionMatrix),T.multiply(L.matrixWorldInverse),T.multiply(n.matrixWorld),h.setFromNormalAndCoplanarPoint(u,d),h.applyMatrix4(L.matrixWorldInverse),p.set(h.normal.x,h.normal.y,h.normal.z,h.constant);const M=L.projectionMatrix;S.x=(Math.sign(p.x)+M.elements[8])/M.elements[0],S.y=(Math.sign(p.y)+M.elements[9])/M.elements[5],S.z=-1,S.w=(1+M.elements[10])/M.elements[14],p.multiplyScalar(2/p.dot(S)),M.elements[2]=p.x,M.elements[6]=p.y,M.elements[10]=p.z+1-o,M.elements[14]=p.w,n.visible=!1;const F=R.getRenderTarget(),N=R.xr.enabled,B=R.shadowMap.autoUpdate;R.xr.enabled=!1,R.shadowMap.autoUpdate=!1,R.setRenderTarget(C),R.state.buffers.depth.setMask(!0),R.autoClear===!1&&R.clear(),R.render(k,L),R.xr.enabled=N,R.shadowMap.autoUpdate=B,R.setRenderTarget(F);const X=_.viewport;X!==void 0&&R.state.viewport(X),n.visible=!0},this.getRenderTarget=function(){return C},this.dispose=function(){C.dispose(),n.material.dispose()}}}Oi.ReflectorShader={name:"ReflectorShader",uniforms:{color:{value:null},tDiffuse:{value:null},textureMatrix:{value:null}},vertexShader:`
		...
		}`};class Bi extends ie{constructor(t,e={}){super(t),this.isRefractor=!0,this.type="Refractor",this.camera=new be;const n=this,r=e.color!==void 0?new St(e.color):new St(8355711),s=e.textureWidth||512,a=e.textureHeight||512,o=e.clipBias||0,l=e.shader||Bi.RefractorShader,c=e.multisample!==void 0?e.multisample:4,h=this.camera;h.matrixAutoUpdate=!1,h.userData.refractor=!0;const u=new We,d=new Nt,f=new mn(s,a,{samples:c,type:Ye});this.material=new ze({name:l.name!==void 0?l.name:"unspecified",uniforms:Hi.clone(l.uniforms),vertexShader:l.vertexShader,fragmentShader:l.fragmentShader,transparent:!0}),this.material.uniforms.color.value=r,this.material.uniforms.tDiffuse.value=f.texture,this.material.uniforms.textureMatrix.value=d;const g=function(){const S=new E,T=new E,L=new Nt,C=new E,A=new E;return function(k){return S.setFromMatrixPosition(n.matrixWorld),T.setFromMatrixPosition(k.matrixWorld),C.subVectors(S,T),L.extractRotation(n.matrixWorld),A.set(0,0,1),A.applyMatrix4(L),C.dot(A)<0}}(),v=function(){const S=new E,T=new E,L=new Cn,C=new E;return function(){n.matrixWorld.decompose(T,L,C),S.set(0,0,1).applyQuaternion(L).normalize(),S.negate(),u.setFromNormalAndCoplanarPoint(S,T)}}(),p=function(){const S=new We,T=new Gt,L=new Gt;return function(A){h.matrixWorld.copy(A.matrixWorld),h.matrixWorldInverse.copy(h.matrixWorld).invert(),h.projectionMatrix.copy(A.projectionMatrix),h.far=A.far,S.copy(u),S.applyMatrix4(h.matrixWorldInverse),T.set(S.normal.x,S.normal.y,S.normal.z,S.constant);const R=h.projectionMatrix;L.x=(Math.sign(T.x)+R.elements[8])/R.elements[0],L.y=(Math.sign(T.y)+R.elements[9])/R.elements[5],L.z=-1,L.w=(1+R.elements[10])/R.elements[14],T.multiplyScalar(2/T.dot(L)),R.elements[2]=T.x,R.elements[6]=T.y,R.elements[10]=T.z+1-o,R.elements[14]=T.w}}();function m(S){d.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),d.multiply(S.projectionMatrix),d.multiply(S.matrixWorldInverse),d.multiply(n.matrixWorld)}function b(S,T,L){n.visible=!1;const C=S.getRenderTarget(),A=S.xr.enabled,R=S.shadowMap.autoUpdate;S.xr.enabled=!1,S.shadowMap.autoUpdate=!1,S.setRenderTarget(f),S.autoClear===!1&&S.clear(),S.render(T,h),S.xr.enabled=A,S.shadowMap.autoUpdate=R,S.setRenderTarget(C);const k=L.viewport;k!==void 0&&S.state.viewport(k),n.visible=!0}this.onBeforeRender=function(S,T,L){L.userData.refractor!==!0&&g(L)&&(v(),m(L),p(L),b(S,T,L))},this.getRenderTarget=function(){return f},this.dispose=function(){f.dispose(),n.material.dispose()}}}Bi.RefractorShader={name:"RefractorShader",uniforms:{color:{value:null},tDiffuse:{value:null},textureMatrix:{value:null}},vertexShader:`
...
`;class pg{constructor(){Xt(this,"group");const t=new kn,e=t.load(ag);e.wrapS=Te,e.wrapT=Te;const n=t.load(og);n.wrapS=Te,n.wrapT=Te;const r=t.load(lg);r.wrapS=Te,r.wrapT=Te;const s=t.load(cg),a=new fn({color:16777215,specular:16777215,shininess:2}),o={grassTexture:{value:e,type:"t"},rockTexture:{value:n,type:"t"},dirtTexture:{value:r,type:"t"},pathMask:{value:s,type:"t"}};a.defines={USE_UV:!0},a.onBeforeCompile=g=>{g.uniforms.grassTexture=o.grassTexture,g.uniforms.rockTexture=o.rockTexture,g.uniforms.dirtTexture=o.dirtTexture,g.uniforms.pathMask=o.pathMask,g.fragmentShader=dg+g.fragmentShader,g.fragmentShader=g.fragmentShader.replace("#include <map_fragment>",fg),console.debug(g.vertexShader),console.debug(g.fragmentShader)};const l=new Pa(1e3),c=new ie(l,a);c.rotateX(-Math.PI/2),c.rotateZ(Math.PI/2),c.receiveShadow=!0;const h=new Gi(20,60),u=new kn().load(hg),d=new kn().load(ug),f=new Hr(h,{color:7842559,scale:2,flowDirection:new st(1,1),textureWidth:1024,textureHeight:1024,normalMap0:u,normalMap1:d});f.rotateX(-Math.PI/2),f.position.set(-20,.01,0),this.group=new dn,this.group.add(f),this.group.add(c)}}class mg{constructor(t){Xt(this,"scene",new lm);Xt(this,"camera");Xt(this,"rollercoaster");Xt(this,"spinningChairs");Xt(this,"sunLight");Xt(this,"skySunUniform");this.rollercoaster=new rg(this.scene),this.rollercoaster.group.position.set(0,10,0),this.spinningChairs=new sg(this.scene),this.spinningChairs.group.position.set(40,0,-40),this.scene.add(new pg().group),this.camera=new be,this.camera.position.set(0,6,6),this.camera.lookAt(0,0,0),new Gm(this.camera,t),this.createLights(),this.createHelpers(),this.createSky()}createSky(){const t=new zr;t.scale.setScalar(45e4),this.scene.add(t);const e=t.material.uniforms;e.turbidity.value=2,e.rayleigh.value=.6,e.mieCoefficient.value=.002,e.mieDirectionalG.value=.9,this.skySunUniform=e.sunPosition}createLights(){const t=new Im;t.position.set(0,60,30),t.castShadow=!0,this.scene.add(t),this.sunLight=t,t.shadow.camera.left=-80,t.shadow.camera.right=80,t.shadow.camera.top=80,t.shadow.camera.bottom=-80,t.shadow.camera.far=300,t.shadow.bias=-5e-4;const e=new Bm(t.shadow.camera);this.scene.add(e);const n=new Pm(11184895,11206570,.5);this.scene.add(n);const r=new Dm(16777130,15,0,1),s=[new E(-50,10,-50),new E(50,10,-50),new E(-50,10,50),new E(50,10,50)];for(const a of s){const o=r.clone();o.position.set(a.x,a.y,a.z),this.scene.add(o);const l=new Fm(o);this.scene.add(l)}}createHelpers(){const t=new Om(100);this.scene.add(t);const e=new Ul(10);this.scene.add(e)}updateAspect(t){this.camera.aspect=t,this.camera.updateProjectionMatrix()}update(t,e){if(this.rollercoaster.updateCart(e),this.spinningChairs.update(e),this.sunLight){const n=t/5;this.sunLight.position.set(80*Math.cos(n),80*Math.sin(n),30),this.sunLight.intensity=Math.sin(n)>0?Math.sin(n):0,this.skySunUniform.value.copy(this.sunLight.position)}}render(t){if(!this.camera)throw new Error("No hay una cámara activa");t.render(this.scene,this.camera)}}class gg{constructor(t){Xt(this,"renderer",new om({antialias:!0}));Xt(this,"park");Xt(this,"lastTime",0);Xt(this,"resize",t=>{this.park.updateAspect(t.offsetWidth/t.offsetHeight),this.renderer.setSize(t.offsetWidth,t.offsetHeight)});Xt(this,"animate",t=>{const e=(t-this.lastTime)/1e3;this.lastTime=t,this.park.render(this.renderer),this.park.update(t/1e3,e)});this.renderer.shadowMap.enabled=!0,this.renderer.toneMappingExposure=.1,this.park=new mg(this.renderer.domElement),this.setupRendering(t)}setupRendering(t){t.append(this.renderer.domElement),this.resize(t),window.addEventListener("resize",()=>{this.resize(t)}),this.renderer.setAnimationLoop(this.animate)}}const _g=document.querySelector("#container");new gg(_g);
